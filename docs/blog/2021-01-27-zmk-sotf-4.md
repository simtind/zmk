...
- Behavior "locality", allowing improved split usage for things like `&zmk_reset`, and controlling external power and RGB underglow for both sides - [petejohanson]
